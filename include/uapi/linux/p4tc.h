...
#define P4TC_TABLE_EXTERN_MAX (__P4TC_TABLE_EXTERN_MAX - 1)
...
enum {
	...
	P4TC_TABLE_EXTERNS, /* nested externs */
	__P4TC_TABLE_MAX
};
...
enum {
	P4TC_FILTER_OPND_EXT_UNSPEC,
	P4TC_FILTER_OPND_EXT_NAME, /* string  */
	P4TC_FILTER_OPND_EXT_ID, /* u32 */
	P4TC_FILTER_OPND_EXT_INST_NAME, /* string  */
	P4TC_FILTER_OPND_EXT_PARAMS, /* nested params */
	__P4TC_FILTER_OPND_EXT_MAX
};

#define P4TC_FILTER_OPND_EXT_MAX (__P4TC_FILTER_OPND_EXT_MAX - 1)
...
enum {
	...
	P4TC_FILTER_OPND_ENTRY, /* nested entry operands -
				 ...
				 */
	P4TC_FILTER_OPND_EXT, /* nested extern -
			       * P4TC_FITLER_OPND_EXT_XXX
			       */
...
enum {
	...
	P4TC_EXT_PARAMS_VALUE_RAW, /* binary - mandatory for runtime params
				      create.
				    */
