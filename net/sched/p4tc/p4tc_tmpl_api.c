...
static const struct rtnl_msg_handler p4tc_tmpl_rtnl_msg_handlers[] __initconst =
{
	{.msgtype = RTM_CREATEP4TEMPLATE, .doit = tc_ctl_p4_tmpl_cu},
	{.msgtype = RTM_UPDATEP4TEMPLATE, .doit = tc_ctl_p4_tmpl_cu},
	{.msgtype = RTM_DELP4TEMPLATE, .doit = tc_ctl_p4_tmpl_delete},
	{.msgtype = RTM_GETP4TEMPLATE, .doit = tc_ctl_p4_tmpl_get,
	 .dumpit = tc_ctl_p4_tmpl_dump},
};

static int __init p4tc_template_init(void)
{
	rtnl_register_many(p4tc_tmpl_rtnl_msg_handlers);
